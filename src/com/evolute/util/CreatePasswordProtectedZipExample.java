...
public class CreatePasswordProtectedZipExample {
	public static void mainasasa(String[] args) {
		try {
	...
	public static int vZipIt(String sInFile,String sOutFile, String sPassword){ 
	try {
		// This is name and path of zip file to be created
		//ZipFile zipFile = new ZipFile("C:/temp/test.zip");
		ZipFile zipFile = new ZipFile(sOutFile);

		// Add files to be archived into zip file
		ArrayList<File> filesToAdd = new ArrayList<File>();
		//filesToAdd.add(new File("C:/temp/test1.txt"));
		//filesToAdd.add(new File("C:/temp/test2.txt"));
		filesToAdd.add(new File(sInFile));
